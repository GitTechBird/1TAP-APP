...
import numpy as np
from .NLP_search_new import preprocess_data, train_tfidf_vectorizer, intelligent_search, load_tfidf_vectors, load_preprocessed_data, intelligent_search_advance
import frappe
...
def search(query):
    ...
    results = intelligent_search_advance(query, preproc_file_data, vectorizer)
    return results
